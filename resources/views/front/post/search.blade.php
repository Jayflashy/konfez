...
@section('title') {{$search}} @lang('Search results') @endsection
@section('meta')
<!-- Open Graph / Facebook -->
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <h4 class="page-title"> {{$search}} @lang('Search results')</h4>
        <div class="card">
            <div class="card-body" id="alpos">
                ...
                <div class="panel">
                    <div class="panel-body text-center">
                        <div class="display-1 text-muted mb-2"><i class="fa fa-face-frown"></i></div>
                        @lang('Sorry Your request wasnt found on our server. Please search again')                        
                    </div>
                </div>
                @endforelse
